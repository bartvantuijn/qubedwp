    ...
    <div class="block-image py-5" data-block-count="<?php echo $args['blockCount']; ?>">
        ...
        <div class="container">
            ...
            <?php if ( $position == 'top' ) : ?>
                ...
                <?php if ( have_rows('tekst') ) : ?>
                    ...
                    <?php while ( have_rows('tekst') ) : the_row();
                        ...
                        <div class="row <?php echo $position_background . ' ' . $position_color; ?>">

                            <div class="col-lg p-5 my-5" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <?php if ( $position == 'left' || $position == 'right' ) : ?>
                    ...
                    <?php if ( have_rows('tekst') ) : ?>
                        ...
                        <?php while ( have_rows('tekst') ) : the_row();
                            ...
                            <div class="col-lg <?php echo $position_background . ' ' . $position_color; ?> p-5 my-5 <?php echo $position == 'left' ? 'order-1' : 'order-3'; ?>" data-aos="fade-up">
                ...
                <div class="img col-lg p-5 my-5 order-2" style="min-height:<?php echo $height ?: '450px'; ?>;background-image:url('<?php echo $image; ?>');background-size:cover;background-position:center;background-blend-mode:multiply;" data-aos="fade-up">
                    ...
                    <?php if ( $position == 'center' ) : ?>
                        ...
                        <?php if ( have_rows('tekst') ) : ?>
                            ...
                            <?php while ( have_rows('tekst') ) : the_row();
                                ...
                                <div class="<?php echo $position_background . ' ' . $position_color; ?>">
