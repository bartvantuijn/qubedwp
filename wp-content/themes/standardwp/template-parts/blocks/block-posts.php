            ...
            <div class="row">
                ...
                <?php foreach( $posts as $post ):
                    ...
                    <div class="col-lg card border-0">
                        <a href="#" class="card-image-top p-5" style="min-height:350px;background-image:url('<?php echo wp_get_attachment_image_url( get_post_thumbnail_id($post->ID), 'full') ?: bloginfo('template_url') . '/img/placeholder.png'; ?>');background-origin:content-box;background-size:contain;background-position:center;background-repeat:no-repeat;background-blend-mode:multiply;"></a>
